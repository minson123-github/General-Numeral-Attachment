...
def train(args):
    ...
    for epoch in range(args['n_epoch']):
        ...
        with torch.no_grad():
            ...
            for batch_embeds, batch_labels in test_dataloader:
                ...
                r7_outputs = outputs[:, 2]
                r7_batch_labels = batch_labels[:, 2]
                ...
                r15_outputs = outputs[:, 3]
                r15_batch_labels = batch_labels[:, 3]
                ...
                r30_outputs = outputs[:, 4]
                r30_batch_labels = batch_labels[:, 4]
    ...
    print('Best F1-Score: {:.3f} {:.3f}, {:.3f}, {:.3f}, {:.3f}, Best epoch: {}'.format(best_triple[0], best_triple[1], best_triple[2], best_triple[3], best_triple[4], best_epoch))
...
def test(args):
    ...
    linear_layer = torch.load(os.path.join(save_dir, 'linear.pt'))
    test_dataloader = get_test_dataloader(args, tokenizer, roberta_layer)
