...
def get_config():
    ...
    parser.add_argument('--predict_day', type=int, help='The day want to predict.')
    parser.add_argument('--padding_embed', type=int, help='Number of padding empty embedding.')
